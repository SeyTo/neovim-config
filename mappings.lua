...
local mappings = {
  n = {
    ...
    -- vim-sandwich
    ["s"] = "<Nop>",
    ["<leader>Q"] = { "<cmd>:qa<cr>", desc = "Exit nvim" },
    ...
    ["<leader>h"] = { desc = "Hop" },
    ["<leader>hc"] = { "<cmd>HopChar1<cr>", desc = "Character" },
    ["<leader>hC"] = { "<cmd>HopChar2<cr>", desc = "2 Characters" },
    ["<leader>hl"] = { "<cmd>HopLine<cr>", desc = "Line" },
    ["<leader>hp"] = { "<cmd>HopPattern<cr>", desc = "Pattern" },
    ["<leader>hw"] = { "<cmd>HopWord<cr>", desc = "Word" },
    -- ["<leader>hf"] = { ":lua require('harpoon.ui').toggle_quick_menu()<cr>", "Harpoon quick menu" },
    -- ["<leader>ha"] = { ':lua require("harpoon.mark").add_file()', "Harpoon add file" },
  },
  v = {
